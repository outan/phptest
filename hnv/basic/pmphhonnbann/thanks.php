<?php
	if (! isset($thanks_message)) {
		$thanks_message = '資料のご請求、ありがとうございました。';
	}
		...
		<td align="left" width="565">
			...
			<!--contents start-->
				<div style="margin-top:10px; margin-bottom:15px; text-align:left; background-color: #ffffff; ">
						...
						<div style="padding:10px; background-color:#FFFFCC; text-align:center; ">
                        	<div class="title" style="margin-top:20px; text-align:center; color:#3300CC;">
								<?php echo $thanks_message; ?>
							  </div>
							</div>

                        	<div class="t" style="margin-bottom:10px; margin-top:20px; ">
																									追ってご記入いただいたメールアドレスへ確認メールが行きます。2〜3日たっても届かない場合は、下記までお問い合わせください。</div>
                         <div class="t" style="padding:10px; border:1px solid #cccccc; "> 〒100-0011　東京都千代田区内幸町2-2-2 富国生命ビル<br>
	株式会社ネクスウェイ<br>
	FNX資料請求受付窓口<br>
	メールアドレス：<a href="mailto:clp@nexway.co.jp">clp@nexway.co.jp</a> </div>
                         <div class="t" style="margin-top:10px; ">約1週間ほどでお届けいたします。いましばらくお待ちください。 </div>
																										
																										<div class="t" style="margin-top:20px; padding-top:5px; border:1px solid #6666cc;border-width:1 0 0 0; text-align:left; "><a href="http://www.fnx.jp/hnv/index.php">トップページへもどる</a></div>
