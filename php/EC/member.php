<?php
	...
	if( isset($_REQUEST["cmd"])&&$_REQUEST["cmd"] == "regist_member" )
	{
		if( isset($_SESSION["customer_code"])&&$_SESSION["customer_code"] != "" )
		{
			...
			//<script> javascriptは実現できないようです。
            // document object model：更新後の画面上のログイン中の名前を更新
...
?>
        ...
        <!-- ウェルカム（ログイン時） -->
        <div class="box">
          <div class="top">ようこそ<span id="person"><?php if(isset($_SESSION["name"])){print($_SESSION["name"]);}?></span>さん！</div>
          <div class="bottom">
